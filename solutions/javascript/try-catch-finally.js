...
// Print  on a new line. If no exception was thrown, then this should be the reversed string; if
// an exception was thrown, this should be the original string.
...
//  is a string type, so it can be reversed without throwing an exception. 
...
// When we try to reverse it anyway, it throws an exception. We then catch the exception and 
// print its , which is s.split is not a function. Next, we finally print  which, because 
// it wasn't able to be reversed, is Number(1234).
